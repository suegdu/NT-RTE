...
&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&@&&&&@@@&&&&&&@&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&  """)
 ...
 try:
  if Components_exists==True:
     ...
     print(Fore.LIGHTBLACK_EX+f"[{Fore.RED}ERROR{Fore.LIGHTBLACK_EX}]:> Components files are missing. try to do a fresh re install for the entire NT procedure and make sure to do not delete any files.")
